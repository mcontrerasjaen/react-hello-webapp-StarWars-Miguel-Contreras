...
export const DetallesOrganizacion = ({ info, volver }) => {
     const { store, dispatch } = useGlobalReducer();

    if (!info) return null;
    
    // Extraemos los datos para asegurar que lleguen bien
    const organizacion = info.data || info;
    const esFavorito = store.favoritos.some(f => f._id === organizacion._id);
